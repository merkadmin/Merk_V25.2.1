...
namespace EntitiesBL.EntitiesCommonBL
{
	public class DBCommon : IDBCommon
	{
		...
		public static ERPSystemEntities _context;

		public static ERPSystemEntities DBContext_External
		{
			get
			{
				if (_context == null)
					return new ERPSystemEntities();
				return _context;
			}
		}

		public static ERPSystemEntities DBContext_Embedded
		{
			get
			{
				if (_context == null)
